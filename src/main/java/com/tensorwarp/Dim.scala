...
object Dim {
  def _1d(x: Int, examples: Int): Dim = new Dim(1, x, 1, 1, examples)
  def _2d(x: Int, y: Int, examples: Int): Dim = new Dim(2, x, y, 1, examples)
  def _3d(x: Int, y: Int, z: Int, examples: Int): Dim = new Dim(3, x, y, z, examples)
}